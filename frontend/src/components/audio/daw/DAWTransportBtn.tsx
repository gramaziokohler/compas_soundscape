  ...
  return (
    <button
      ...
      style={{
        ...
        height: 28,
        borderRadius: '50%',
        border: active ? '1.5px solid var(--color-primary)' : '1.5px solid var(--color-overlay-border)',
        backgroundColor: active ? 'var(--color-primary)' : 'var(--color-secondary-lighter)',
        color: active ? 'var(--color-on-blue)' : 'var(--foreground)',
        cursor: 'pointer',
        display: 'flex',
        alignItems: 'center',
