...
## 🚀 Project Context
  ...
  * **Architecture:** Speckle + FastAPI (Backend) + Next.js 15 (Frontend) + Speckle Viewer (Three.js , 3D Visualization)
  * **Backend Environment:** Mamba environment `compas-toy`
  * **Key Technologies:** Speckle, Google Gemini, TangoFlux, rhino3dm, React 19, WaveForm
  * **Speckle documentation:** 'speckle_docs.md'
